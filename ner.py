...
def main(model="fr_core_news_sm", new_model_name='new_model', output_dir=output_dir, n_iter=100):
    ...
    test_text = 'les pommes de terre sont fondantes'
    doc = nlp(test_text)
    print("Entities in '%s'" % test_text)
    print(doc.ents)
    for ent_ in doc.ents:
        pdb.set_trace()
        print(ent_.label_, ent_.text)
    '''
    # Save model 
